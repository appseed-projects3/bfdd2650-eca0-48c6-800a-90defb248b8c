...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-08-06 08:02`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bfdd2650-eca0-48c6-800a-90defb248b8c.git
$ cd bfdd2650-eca0-48c6-800a-90defb248b8c
```
